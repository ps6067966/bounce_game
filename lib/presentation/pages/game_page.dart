                    ...
                    Positioned(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          LeftButton(
                              function: provider.moveLeft, key: Key('left')),
                          SizedBox(
                            width: 20,
                          ),
                          RightButton(
                              function: provider.moveRight, key: Key('right')),
                          Spacer(),
                          JumpButton(function: provider.jump, key: Key('jump')),
                          SizedBox(
                            width: 20,
                          ),
                        ],
                    ...
                    Positioned(
                      ...
                      child: Row(
                        children: [
                          ...
                          ...provider.ringsList
                              .skipWhile((e) => e.isCollected ?? false)
                              .map((e) => Padding(
